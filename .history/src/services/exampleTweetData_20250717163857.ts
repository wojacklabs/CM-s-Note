...
export const testUsernames = [
  'WojackLabs',     // The user that was having issues
  'elonmusk',
  'vitalikbuterin',
  'ethereum',
  'bitcoin',
...
// Common variations of usernames to handle case sensitivity
export const usernameVariations: { [key: string]: string } = {
  'wojacklabs': 'WojackLabs',
  'WojackLabs': 'WojackLabs',
  'wojackLabs': 'WojackLabs',
  'WOJACKLABS': 'WojackLabs',
  'elonmusk': 'elonmusk',
...
// Get the correct username format for Twitter
export function getCorrectUsername(username: string): string {
  return usernameVariations[username] || username;
}
